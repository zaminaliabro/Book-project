  ...
  return (
    <>
      <div className="experience-section">
        <div className="main">
          <h2 className="exprince">Join The Ranks of Successful Authors</h2>
          <p className="subtitle">
            Discover why so many authors choose us to bring their stories to
            life.
          </p>
        </div>
        ...
        <div className="timeline">
          ...
          <div className="timeline-item">
            <div className="icon">
              <div class="flex items-center justify-center w-24 h-24 bg-orange-primary rounded-full shadow-lg mb-6 lg:mb-0 sfpro">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
